...
[![Version](https://img.shields.io/badge/version-1.5.1-blue.svg)](https://github.com/musbabaff/CordSync/releases)
...
1. Download `CordSync-1.5.1.jar` from [Releases](https://github.com/musbabaff/CordSync/releases)
...
*CordSync v1.5.1 — The Ultimate Discord-Minecraft Synchronization Core*
